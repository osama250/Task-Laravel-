...
<div class="container" style="margin-top: 50px">
    <div class="row">
     ...
     <form action="{{ route('Comapny.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
        {{ csrf_field() }}
        <div class="col-lg-6">
          ...
          <div class="col-lg-6">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" name="adress" placeholder="Write Adrees">
          </div>
          <div class="col-lg-6">
            <label for="exampleFormControlInput1" class="form-label"> Adress</label>
